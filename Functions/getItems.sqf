...
//////////////////////////////////Weapons and Magazines////////////////////////////////////
	...
	_val = [_veh, _weapons, 3] call MLS_fnc_transferGear;
...
/////////////////////////////////Uniform and Uniform Contents/////////////////////////////
	...
	if (!((uniform _trg) isEqualTo "")) then {
		_val = [_veh, _uniformItems, 0] call MLS_fnc_transferGear;
		if (_val > 0) then {
			_vehFull = 1;
		};
	};
...
/////////////////////////////////Vest and Vest Contents//////////////////////////////////
	...
	if (!((vest _trg) isEqualTo "")) then {
		_val = [_veh, _vestItems, 1] call MLS_fnc_transferGear;
		if (_val > 0) then {
			_vehFull = 1;
		};
	};
...
///////////////////////////////Backpack and Backpack Contents//////////////////////////	
	...
	if (!((backpack _trg) isEqualTo "")) then {
		_val = [_veh, _backpackItems, 2] call MLS_fnc_transferGear;
		if (_val > 0) then {
			_vehFull = 1;
		};
	};
...
///////////////////////////////Headgear and Assigned Items//////////////////////////////////////////////////
...
}else{											/////////////////////////Adding items on ground to vehicle////////////////////////////////////
	...
	/*
	_val = [_veh, _items, 3] call MLS_fnc_transferGear;
